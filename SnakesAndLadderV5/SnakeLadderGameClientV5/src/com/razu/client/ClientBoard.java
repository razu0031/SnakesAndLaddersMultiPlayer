...
public final class ClientBoard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ThisUserScoreLabel.setText("score");
        ThisUserScoreLabel.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        User2ScoreLabel.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        User3ScoreLabel.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        User4ScoreLabel.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        StartPanel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JDialog frame = new JDialog(this, "Avatar List", true);
        NotificationPane avatarPanel = new NotificationPane(frame, 
                                       "HI how are you. What are you doing ?", 
                                       NotificationPane.INFORMATION);
        avatarPanel.setOpaque(false);
        frame.getContentPane().add(avatarPanel);
        frame.setBounds(this.getX()+150, this.getY()+150, 
                        avatarPanel.getWidth(), avatarPanel.getHeight());
