...
import static com.razu.client.ServerDataProcessor.*;
...
public class ClientBoard extends javax.swing.JFrame {
    ...
    public static boolean settingButtonClicked = false;
    ...
    public ClientBoard() {
        ...
        try {
            startPageAnimation(applicationRunning);
    ...
    private void initializeUserInterface(){
        makeButtonBackgroundTransparent(PlayButton);
        makeButtonBackgroundTransparent(SettingsButton);
        makeButtonBackgroundTransparent(ExitButton);
        makeButtonBackgroundTransparent(HomeButton);
        makeButtonBackgroundTransparent(SettingExitButton);
        makeButtonBackgroundTransparent(SettingsOkButton);
        makeButtonBackgroundTransparent(AcceptRequestButton);
        makeButtonBackgroundTransparent(DenyRequestButton);
        makeButtonBackgroundTransparent(InviteButton);
        placeListElementAtCenter(AvailablePlayerList);
        setVisibility(StartPanel, true);
        setVisibility(GamePanel, false);
            ...
            public void run() {
                ...
                while (continueCommunication){
                    try {
                        messageFromServer = client.READ_MESSAGE_FROM_SERVER();
                        continueCommunication = client.CONTINUE_COMMUNICATION();
                        UPDATE(messageFromServer);
                        
                        Thread.sleep(1);
                    } catch (IOException ex) {
                        System.err.println("scIO = "+ex);
    ...
    private void initializeThisUser(String userName) throws IOException{  
        //openNewConnection();
        userPort = client.CLIENT_SOCKET.getLocalPort();
        ThisUser.setText(userName+userPort);     

        if(continueCommunication){
            String messageToClient = "UserName@"+userName;
            client.SEND_MESSAGE_TO_SERVER(messageToClient, true);
            if(thread == null)startAndContinueGame();
        }
    }
    ...
    private void initComponents() {
        ...
        GameDataLabel = new javax.swing.JLabel();
        ThisUser = new javax.swing.JLabel();
        User1Label = new javax.swing.JLabel();
        User1LabelActive = new javax.swing.JLabel();
        ...
        GameDataLabel.setFont(new java.awt.Font("Lucida Calligraphy", 1, 15)); // NOI18N
        GameDataLabel.setForeground(new java.awt.Color(158, 0, 0));
        GameDataLabel.setText("Game Data : ");
        PlayerBenchPanel.add(GameDataLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, -1, -1));

        ThisUser.setFont(new java.awt.Font("Lucida Calligraphy", 1, 15)); // NOI18N
        ThisUser.setForeground(new java.awt.Color(158, 0, 0));
        ThisUser.setText("This User ");
        PlayerBenchPanel.add(ThisUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, -1, -1));

        User1Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/user1.png"))); // NOI18N
        PlayerBenchPanel.add(User1Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 23, 54, 54));

        User1LabelActive.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/userActive.png"))); // NOI18N
        PlayerBenchPanel.add(User1LabelActive, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 60, 60));

        User2Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/user2.png"))); // NOI18N
        PlayerBenchPanel.add(User2Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 23, 54, 54));

        User2LabelActive.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/userActive.png"))); // NOI18N
        PlayerBenchPanel.add(User2LabelActive, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 60, 60));

        User3Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/user3.png"))); // NOI18N
        PlayerBenchPanel.add(User3Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(193, 23, 54, 54));

        User3LabelActive.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/razu/client/Images/userActive.png"))); // NOI18N
        PlayerBenchPanel.add(User3LabelActive, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 20, 60, 60));
        ...
        javax.swing.GroupLayout AvailablePlayerListPanelLayout = new javax.swing.GroupLayout(AvailablePlayerListPanel);
        AvailablePlayerListPanel.setLayout(AvailablePlayerListPanelLayout);
        AvailablePlayerListPanelLayout.setHorizontalGroup(
            AvailablePlayerListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(AvailablePlayerListPanelLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addGroup(AvailablePlayerListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ListBasePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                    .addComponent(AvailablePlayerListHeadingBasePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE))
                .addContainerGap(11, Short.MAX_VALUE))
        );
        AvailablePlayerListPanelLayout.setVerticalGroup(
            AvailablePlayerListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(AvailablePlayerListPanelLayout.createSequentialGroup()
                .addGap(9, 9, 9)
                .addComponent(AvailablePlayerListHeadingBasePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ListBasePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 314, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10))
        );
        ...
        DiceRollingPanel.setBorder(dropShadowBorder7);
        ...
        dropShadowBorder8.setCornerSize(30);
        dropShadowBorder8.setShadowColor(new java.awt.Color(88, 203, 233));
        dropShadowBorder8.setShadowSize(10);
        dropShadowBorder8.setShowLeftShadow(true);
        dropShadowBorder8.setShowTopShadow(true);
        SettingsPanel.setBorder(dropShadowBorder8);
        ...
        UserNickNameTextField.setBorder(dropShadowBorder9);
        ...
        ServerAddressTextField.setBorder(dropShadowBorder10);
    ...
    private void PlayButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PlayButtonActionPerformed
        ...
        if(!SettingsBasePanel.isVisible()){ 
            if(userNickName.trim().length()==0  || userNickName.contains(",") || userNickName.contains("@")){
                setVisibility(SettingsBasePanel, true);
                UserNickNameTextField.setText(userNickName);
            }
            else {
                try {
                    initializeThisUser(userNickName);
                    //InvitationLabel.setText("You along with razu0031, rafi 0051, nayeem109 are requested to play by frahad1220 and there are many other at online");
    ...
    private void HomeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HomeButtonActionPerformed
        if(!InvitationPanel.isVisible()){
            try {
                client.SEND_MESSAGE_TO_SERVER("Bye", false);
                thread.stop();
                client.DATA_FROM_SERVER.close();
                client.DATA_TO_SERVER.close();
    ...
    private void DiceRollButttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DiceRollButttonActionPerformed
        if(!InvitationPanel.isVisible()){
            DiceRollButtton.setEnabled(false);
            try{  
                rollDice(client);
    ...
    private void SettingsOkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SettingsOkButtonActionPerformed
        ...
        if(UserNickNameTextField.getText().trim().length()!=0){
            System.out.println("len="+UserNickNameTextField.getText().trim().length());
            String userName = UserNickNameTextField.getText().trim();
            serverAddress = ServerAddressTextField.getText().trim();
    ...
    private void AvailablePlayerListFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_AvailablePlayerListFocusGained
        selectedPlayerList = controlInvitationButtonVisibility();
    ...
    private void AvailablePlayerListMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AvailablePlayerListMouseMoved
        controlInvitationButtonVisibility();
    ...
    public static javax.swing.JButton AcceptRequestButton;
    public static javax.swing.JList<String> AvailablePlayerList;
    private javax.swing.JLabel AvailablePlayerListHeading;
    ...
    public static javax.swing.JButton DenyRequestButton;
    public static javax.swing.JLabel Dice1;
    public static javax.swing.JLabel Dice2;
    public static javax.swing.JLabel Dice3;
    public static javax.swing.JLabel Dice4;
    public static javax.swing.JLabel Dice5;
    public static javax.swing.JLabel Dice6;
    public static javax.swing.JButton DiceRollButtton;
    private jpanelcustom.JPanelCz DiceRollingPanel;
    private javax.swing.JLabel Divi;
    private javax.swing.JButton ExitButton;
    public static javax.swing.JLabel GameDataLabel;
    public static javax.swing.JPanel GamePanel;
    private javax.swing.JLabel GamePanelBackgroundLabel;
    private javax.swing.JButton HomeButton;
    public static org.jdesktop.swingx.JXLabel InvitationLabel;
    public static jpanelcustom.JPanelCz InvitationPanel;
    public static javax.swing.JButton InviteButton;
    public static javax.swing.JLabel Ladder;
    private jpanelcustom.JPanelC LeftPanel;
    private jpanelcustom.JPanelCz ListBasePanel;
    public static jpanelcustom.JPanelCz LudoBoardPanel;
    public static jpanelcustom.JPanelC NickNameBasePanel;
    private javax.swing.JButton PlayButton;
    private jpanelcustom.JPanelCz PlayerBenchPanel;
    public static jpanelcustom.JPanelCz RightUpPanel;
    public static jpanelcustom.JPanelC ServerAddressBasePanel;
    public static javax.swing.JTextField ServerAddressTextField;
    private javax.swing.JButton SettingExitButton;
    public static javax.swing.JPanel SettingsBasePanel;
    private javax.swing.JButton SettingsButton;
    private javax.swing.JButton SettingsOkButton;
    private jpanelcustom.JPanelCz SettingsPanel;
    public static javax.swing.JLabel Snake;
    public static javax.swing.JLabel Snake2;
    public static javax.swing.JPanel StartPanel;
    private javax.swing.JLabel StartPanelBackgroundLabel;
    public static javax.swing.JLabel ThisUser;
    private javax.swing.JLabel User1Label;
    public static javax.swing.JLabel User1LabelActive;
    private javax.swing.JLabel User2Label;
    public static javax.swing.JLabel User2LabelActive;
    private javax.swing.JLabel User3Label;
    public static javax.swing.JLabel User3LabelActive;
    public static javax.swing.JTextField UserNickNameTextField;
